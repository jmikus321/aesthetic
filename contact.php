				...
				<div class="row row-pb-md">
					<div class="col-md-6 animate-box">
							...
							if(isset($_POST['email'])) {
								...
								if($response->success){
									...
									if (mail($to, $subject, $body, $headers)) {
										...
										$feedback = "Email was successfully sent!";
									} else {
										$feedback = "There was an error sending the email, please try again.";
										http_response_code(500);
									}
									} else {
										
										//neuspesna recaptcha
										$feedback = "Please complete the reCAPTCHA verification and try again.";
								}
							}
						?>		

						<div><h1><?php echo $feedback; ?></h1></div>
						...
						<form method="post">
							...
							<button class="g-recaptcha" type="submit">Odoslať</button>
					...
					<div class="col-md-5 col-md-push-1 animate-box">
						<div class="gtco-contact-info">
							...
							<ul>
								...
								<a href="tel:XXX" class="icon-spacing"><i class="ti-mobile"></i></a>
